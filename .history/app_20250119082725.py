...
def get_required_information(resource_type: str) -> List[str]:
    ...
    try:
        chat = model.start_chat(history=[
            ...
            {
                "role": "model",
                "parts": ["I will provide only the necessary questions (always including the access key, specific  associated to the user's account) for the most basic Terraform cloud infrastructure configuration when given a resource type. Please provide the resource type."]
            }
        ])
